...
class Admin::ManagersControllerTest < ActionController::TestCase
  ...
  test "should create admin_manager" do
    assert_difference('Admin::Manager.count') do
      post :create, admin_manager: { authority: @admin_manager.authority, password_digest: @admin_manager.password_digest, username: @admin_manager.username }
    end
  ...
  test "should update admin_manager" do
    patch :update, id: @admin_manager, admin_manager: { authority: @admin_manager.authority, password_digest: @admin_manager.password_digest, username: @admin_manager.username }
    assert_redirected_to admin_manager_path(assigns(:admin_manager))
  end
